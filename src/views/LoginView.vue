                    ...
                    <div v-if="isLogin" class="box_login">
                        ...
                        <div class="home_box_subtitle">
                            <label class="item-subtitle text-12-600 text-color-3">
                                Nessa loja virtual é proibida a venda para menores de 18 anos. Se houver produtos proibidos adicionados, apresente um documento com foto na entrada para compovar a sua idade (+18).
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="home_box_top">
                            ...
                            <div class="group-input">
                                <div class="switch__container">
                                    <input id="switch-shadow" class="switch switch--shadow" type="checkbox" v-model="isCheck"/>
                                    <label for="switch-shadow"></label>
                                </div>
                                <label class="text-14-600 w-70">Eu li e concordo com os <span class="text-color-primary">Termos de Uso</span> e <span  class="text-color-primary">Políticas de Privacidade.</span></label>
                            </div>
                            <div class="group-input">
                            ...
                            <div class="home_box_subtitle w-100 text-center">
                                <label class="item-subtitle text-16-600 text-color-3">
                                    Já tem cadastro? <span class="text-color-primary cursor-pointer" @click="enter">Entrar na conta</span>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="home_box_top">
                            ...
                            <div class="home_box_subtitle">
                                <label class="item-subtitle text-16 text-color-3">
                                    Um código de confirmação de 04 digitos foi enviado para <span class="text-16-600 text-color-black">83 99631-7283</span> no whatsapp. Digite o código para confirmar a sua conta.

                                </label>
                            </div>
                            <div class="home_box_login">
                                <div class="group-input">
                                    <input type="text" class="item-input code-confirm" v-model="code" placeholder="Código">
                            ...
                            <div class="home_box_subtitle w-100 text-center">
                                ...
                                <br> 
                                <label class="item-subtitle text-16 text-color-3">
                                Aguarde <span class="text-color-black text-14-600">30s</span> para reenviar
                                </label>
                            </div>
                        </div>
                    </div>
